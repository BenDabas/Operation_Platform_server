...
namespace Operation_Platform.Migrations
{
    ...
    [Migration("20230312085424_DropOperationsTable")]
    partial class DropOperationsTable
    {
            ...
            modelBuilder.Entity("Operation_Platform.Models.Operation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateTime = new DateTime(2023, 3, 12, 10, 54, 23, 720, DateTimeKind.Local).AddTicks(6932),
                            FirstField = "1",
                            Operator = "+",
                            SecondField = "1"
                        });
